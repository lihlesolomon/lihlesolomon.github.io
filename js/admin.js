// Admin Configuration
let isAdmin = false;
const ADMIN_PASSWORD = "n icky123"; // Change this in production
...
function setupPasswordModal() {
    ...
    passwordForm.addEventListener('submit', function(e) {
        ...
        if (password === ADMIN_PASSWORD) {
            ...
            openAdminPanel();
            updateAdminTables();
            showSyncStatus('Admin access granted');
        } else {
...
function updateAdminTables() {
    ...
    database.ref('selections').once('value').then((snapshot) => {
        ...
        Object.entries(selections).forEach(([g  ##### 5. js/admin.js (Complete Final Version)

const ADMIN_PASSWORD = "nicky123"; // Change this in production
let isAdmin = false;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.getElementById('exportRSVPBtn')) {
        setupAdminButtons();
    }
});
    ...
    database  .  ref  (  '  selections  '  )  .  once  (  '  value  '  )  .  then  (  (  snapshot  )  =>  {
        ...
        Object  .  entries  (  selections  )  .  forEach  (  (  [  giftId  ,  selection  ]  )  =>  {
            ...
            if  (  gift  )  {
                ...
                row  .  innerHTML  =  `
                    <  td  >
                        <  img  src  =  "${  gift  .  image  }  "  alt  =  "${  gift  .  name  }  "  class  =  "admin  -  gift  -  image"  onerror  =  "this  .  src  =  '  images  /  default  -  gift  .  jpg  '  "  >
                        ${  gift  .  name  }
                    <  /  td  >
        ...
        document  .  querySelectorAll  (  '  .  unselect  -  button  '  )  .  forEach  (  button  =>  {
            button  .  addEventListener  (  '  click  '  ,  function  (  )  {
                ...
                if  (  confirm  (  `  Are  you  sure  you  want  to  remove  the  selection  for  ${  gift  ?  .  name  ||  '  this  gift  '  }  ?  `  )  )  {
...
function  exportRSVPs  (  )  {
    ...
    database  .  ref  (  '  rsvps  '  )  .  once  (  '  value  '  )  .  then  (  (  snapshot  )  =>  {
        ...
        let  csv  =  '  Name  ,  Email  ,  Attendance  ,  Date  \  n  '  ;
        
        Object  .  values  (  rsvps  )  .  forEach  (  rsvp  =>  {
            csv  +=  `  "  ${  rsvp  .  name  ||  '  '  }  "  ,  "  ${  rsvp  .  email  ||  '  '  }  "  ,  "  ${  rsvp  .  attendance  ||  '  '  }  "  ,  "  ${  rsvp  .  date  ||  '  '  }  "  \  n  `  ;
        }  )  ;
...
function  exportGiftSelections  (  )  {
    ...
    database  .  ref  (  '  selections  '  )  .  once  (  '  value  '  )  .  then  (  (  snapshot  )  =>  {
        const  selections  =  snapshot  .  val  (  )  ||  {  }  ;
        let  csv  =  '  Gift  Name  ,  Selected  By  ,  Option  ,  Date  \  n  '  ;
        
        Object  .  entries  (  selections  )  .  forEach  (  (  [  giftId  ,  selection  ]  )  =>  {
            const  gift  =  gifts  .  find  (  g  =>  g  .  id  ==  giftId  )  ;
            if  (  gift  )  {
                csv  +=  `  "  ${  gift  .  name  ||  '  '  }  "  ,  "  ${  selection  .  selectedBy  ||  '  '  }  "  ,  "  ${  selection  .  option  ||  '  '  }  "  ,  "  ${  selection  .  date  ||  '  '  }  "  \  n  `  ;
            }
        }  )  ;
